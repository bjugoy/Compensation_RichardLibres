 ...
 */
class Book {
    constructor(title, author, isbn, inStock, releaseDate) {
        this.title = title;
        this.author = author;
        this.isbn = isbn;
...
/* Task 1 - Part 2. Replace these three instances of the example Class Resource with instances
   of your own class */
model.add(new Book("Atomic Habits", "James Clear", 12, false, new Date("2023-09-14")));
model.add(new Book("Demian","Hermann Hesse", 22, true, new Date("2023-09-14")));
model.add(new Book("Never Let Me Go", "Kazuo Ishiguro",  32, true, new Date("2023-09-14")));
